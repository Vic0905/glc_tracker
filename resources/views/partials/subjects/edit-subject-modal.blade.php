...
<!-- Edit Subject Modal -->
<div id="editSubjectModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center hidden z-50">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md mx-4 sm:mx-auto">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-gray-800" id="editModalTitle">Edit Subject</h2>
        ...
        <form id="editSubjectForm" method="POST" action="" class="space-y-4">
            ...
            <div>
                <label for="modalSubjectName" class="block text-sm font-medium text-gray-700">Subject Name</label>
                <input
                    type="text"
                    name="subjectname"
                    id="modalSubjectName"
