                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 border-b text-gray-800 flex gap-2">
                                            <div class="flex justify-start gap-2">
                                                <!-- Edit Button -->
                                                <a href="{{ route('teachers.edit', $teacher->id) }}" class="bg-gray-800 hover:bg-transparent px-5 py-2 text-xs shadow-xs hover:shadow-lg font-medium tracking-wider 
                                                    ...
                                                    <div>
                                                        <div class="text-center p-3 flex-auto justify-center">
                                                            ...
                                                            <p class="font-bold text-sm text-gray-500 px-2">
                                                                Do you really want to continue? This process cannot be undone.</p>
                                                        </div>
                                                                                                                <!-- Modal Actions -->
                                                        <div class="p-2 mt-2 text-center flex justify-center items-center space-x-4">
                                                                    <!-- Cancel Button -->
                                                                    <button onclick="closeModal()" class="bg-gray-200 hover:bg-transparent px-5 py-2 text-sm shadow-sm hover:shadow-lg font-medium tracking-wider 
                                                                        border-2 border-gray-900 hover:border-gray-900 text-gray-900 hover:text-gray-100 rounded-xl transition ease-in duration-150">
                                                                        Cancel
                                                                    </button>

                                                            <!-- Confirm Delete Button that Submits the Form -->
                                                            <form id="deleteForm" action="{{ route('teachers.destroy', $teacher->id) }}" method="POST" class="inline">
                                                                @csrf
                                                                @method('DELETE')
