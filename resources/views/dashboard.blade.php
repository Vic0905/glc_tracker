<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Students Count -->
                <div class="bg-gradient-to-br from-gray-100 to-gray-300 overflow-hidden shadow-lg rounded-lg transform hover:scale-105 transition duration-300">
        ...
        {{-- <!-- Recent Activities -->
        <div class="bg-white overflow-hidden shadow-lg rounded-lg p-6 mt-6">
            ...
            <form action="{{ route('activity-logs.delete') }}" method="POST" class="mt-4">
                @csrf
                @method('DELETE')
                <button type="submit" class="cursor-pointer transition-all bg-red-700 text-white px-6 py-2 rounded-lg border-red-400 border-b-[4px] hover:shadow-xl hover:shadow-red-300 shadow-red-300 active:shadow-none hover:bg-transparent text-sm shadow-sm font-medium tracking-wider border-2 hover:border-red-500 hover:text-red-500 ease-in duration-300">
    ...
    <script>
        function animateCount(elementId, targetNumber, duration = 10000) {
            let count = 0;
